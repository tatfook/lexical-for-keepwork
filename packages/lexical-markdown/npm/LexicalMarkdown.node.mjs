...
const mod = await (['development', 'test'].includes(process.env.NODE_ENV) ? import('./LexicalMarkdown.dev.mjs') : import('./LexicalMarkdown.prod.mjs'));
...
export const createBlockNode = mod.createBlockNode;
