      ...
      for (let i = 0; i < mutations.length; i++) {
        ...
        if (type === 'characterData') {
          ...
          for (let s = 0; s < addedDOMs.length; s++) {
            ...
            if (editor._config.ignoreMutationDOMChanges && editor._config.ignoreMutationDOMChanges(addedDOM)) {
              continue;
            }
          ...
          if (removedDOMsLength > 0) {
            ...
            for (let s = 0; s < removedDOMsLength; s++) {
              ...
              if (editor._config.ignoreMutationDOMChanges && editor._config.ignoreMutationDOMChanges(removedDOM)) {
                continue;
              }
